...
export const CartProvider = ({ children }) => {
    ...
    const increaseQuantity = async (itemId) => {
        ...
        try {
            const response = await fetch(`${config.baseUrl}/cart/increase-quantity`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`
            ...
            // Refresh cart details after increasing quantity
            await fetchCartDetails(customerId)
            return true
        } catch (error) {
    ...
    const decreaseQuantity = async (itemId) => {
        ...
        try {
            const response = await fetch(`${config.baseUrl}/cart/decrease-quantity`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`
            ...
            // Refresh cart details after decreasing quantity
            await fetchCartDetails(customerId)
            return true
        } catch (error) {
