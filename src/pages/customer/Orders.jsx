            ...
            {orders.length === 0 ? (
                ...
                <div className="grid gap-4 md:gap-6">
                    {getFilteredOrders().map((order, index) => (
                        <div
                            key={order.id}
                            className="bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer border border-gray-200 hover:border-primary/30"
                                        ...
                                        <div className="flex items-center space-x-2">
                                            ...
                                            <div>
                                                ...
                                                {order.payment_status && (
                                                    <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${order.payment_status === 'paid' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}`}>
                                                        {order.payment_status}
                                                    </span>
                                                )}
                                            </div>
