...
function ShopDetail() {
    ...
    const handleStatusChange = async (branchId) => {
        if(!window.confirm('Are you sure you want to change the status of this branch?')) {
            return
        }

        // Vendor/branches/{id}/togglestatus

        try {
            const response = await fetch(`${config.baseUrl}/Vendor/branches/${branchId}/togglestatus`, {
                method: 'PUT',
            })
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                    ...
                    {isLoading ? (
                        ...
                        <div className="bg-gray-50 p-8 rounded-lg text-center">
                            ...
                            <button
                                className="bg-primary hover:bg-primary-700 py-2 px-4 rounded-lg shadow-md hover:shadow-lg transition-all"
                                onClick={openAddBranchDialog}
                            >
                            ...
                            {branches.map(branch => (
                                <div className="bg-white border rounded-lg shadow overflow-hidden" key={branch.branch_id}>
                                    ...
                                    <div className='flex justify-center items-center'>
                                        <span>Status</span>
                                        <button
                                        onClick={() => handleStatusChange(branch.branch_id)}
                                        className={
                                            `px-3 py-1 rounded-full ${branch.status === 'active' ? 'bg-green-100 text-green-800' :
                        ...
                        <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-xl">
                            ...
                            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                <button
                                    ...
                                    className="inline-flex w-full justify-center rounded-md border border-transparent bg-primary px-4 py-2 text-base font-medium shadow-sm hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm transition-colors"
                                >
                                    Add Branch
                                </button>
                                <button
            ...
            {showUpdateBranchDialog && (
                <div className="fixed inset-0 z-50 overflow-y-auto">
                    <div className="flex min-h-screen items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        ...
                        <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-xl">
                            <div className="bg-primary px-4 py-3">
                                <h3 className="text-lg font-medium leading-6 text-white">Update Branch</h3>
                            </div>
                            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 max-h-[80vh] overflow-y-auto">
                                <div className="sm:flex sm:items-start">
                                    <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
