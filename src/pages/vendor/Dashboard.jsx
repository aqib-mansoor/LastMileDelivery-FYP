  ...
  return (
    <>
      <div className="flex items-center justify-between bg-white p-4 border-b">
        ...
        <div>
          <button
            className="bg-primary hover:bg-primary-700 text-white py-2 px-4 rounded-lg flex items-center shadow-md transition-all hover:shadow-lg"
            ...
            <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
              ...
              <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                <button
                  type="submit"
                  form="add-shop-form"
                  className="inline-flex w-full justify-center rounded-md border border-transparent bg-primary px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm transition-colors"
                >
                  Add Shop
                </button>
                <button
